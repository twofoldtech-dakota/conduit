...
[conduit-mcp](../globals.md) / WordPressAdapter
...
> **new WordPressAdapter**(): `WordPressAdapter`
...
> `readonly` **displayName**: `"WordPress"` = `'WordPress'`
...
> `readonly` **name**: `"wordpress"` = `'wordpress'`
...
> **getContent**(`id`): `Promise`\<[`Content`](../interfaces/Content.md) \| `null`\>
