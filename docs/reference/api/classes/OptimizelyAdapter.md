...
[conduit-mcp](../globals.md) / OptimizelyAdapter

# Class: OptimizelyAdapter
...
> **new OptimizelyAdapter**(): `OptimizelyAdapter`
...
> `readonly` **displayName**: `"Optimizely"` = `'Optimizely'`
...
> `readonly` **name**: `"optimizely"` = `'optimizely'`
