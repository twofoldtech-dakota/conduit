...
[conduit-mcp](../globals.md) / ContentfulAdapter
...
> **new ContentfulAdapter**(): `ContentfulAdapter`
...
> `readonly` **displayName**: `"Contentful"` = `'Contentful'`
...
> `readonly` **name**: `"contentful"` = `'contentful'`
