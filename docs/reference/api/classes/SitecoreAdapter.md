...
[conduit-mcp](../globals.md) / SitecoreAdapter

# Class: SitecoreAdapter
...
> **new SitecoreAdapter**(): `SitecoreAdapter`
...
> `readonly` **displayName**: `"Sitecore XM Cloud"` = `'Sitecore XM Cloud'`
...
> `readonly` **name**: `"sitecore"` = `'sitecore'`
